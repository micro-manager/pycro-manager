...
acq1 = JavaBackendAcquisition(directory=save_path, name='acq1', port=PORT1, debug=True)
acq2 = JavaBackendAcquisition(directory=save_path, name='acq2', port=PORT1, debug=True)
