from pycromanager import JavaBackendAcquisition, multi_d_acquisition_events, start_headless
import napari
...
acq = JavaBackendAcquisition(directory=r"C:\Users\henry\Desktop\data", name="tcz_acq",
                             show_display='napari')
