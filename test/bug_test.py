...
if __name__ == '__main__':  # this is important, don't forget it
    ...
    with Acquisition(directory='/Users/henrypinkard/megellandump/', name='exp_2_mda',
                     image_process_fn=img_process_fn) as acq:
        events = multi_d_acquisition_events(z_start=z_shg_center - 20, z_end=z_shg_center + 20, z_step=5)
