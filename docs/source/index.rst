...
The best place to get started is the :doc:`user_guide`.

The :doc:`tutorials` section shows jupyter notebook tutorials of using pycro-manager for various applications.
