...
import main.java.org.micromanager.plugins.magellan.imagedisplay.DisplaySettings;
import java.io.File;
...
public final class TaggedImageStorageMultipageTiff {
    ...
    * way, ends up submitting the writing task to writingExecutor_.
     ...
     * metadata file and closes it. After calling this function, the
     * imagestorage is read-only
     */
