...
public class StartupHelpWindow extends javax.swing.JFrame {
   ...
   private void updateText() {
      textArea_.setForeground(Color.black);
      if (stepIndex_ == 0 ) {
         ...
         textArea_.setText("<html>Using surfaces in Magellan to alter settings and/or control acqusitions requires" +
                 ...
                 + " the <b>Hardware Configuration Wizard</b> (under the <b>Devices</b> menu)</html>");
         boolean known = false;
         try {
   ...
   private void initComponents() {
      ...
      textArea_.setBackground(new java.awt.Color(204, 204, 255));
      textArea_.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
      textArea_.setText("jLabel1");

      statusLabel_.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
      statusLabel_.setText("Status line");

      linkLabel_.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
      linkLabel_.setText("Link line");

      closeButton_.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
      ...
      prevButton_.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
      ...
      nextButton_.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
      ...
      pageLabel_.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
      ...
      jPanel1Layout.setHorizontalGroup(
         ...
         .addGroup(jPanel1Layout.createSequentialGroup()
            ...
            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
               ...
               .addComponent(statusLabel_, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
               .addComponent(linkLabel_, javax.swing.GroupLayout.PREFERRED_SIZE, 577, javax.swing.GroupLayout.PREFERRED_SIZE))
            .addContainerGap())
         .addGroup(jPanel1Layout.createSequentialGroup()
      ...
      jPanel1Layout.setVerticalGroup(
         ...
         .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
            .addContainerGap()
            .addComponent(textArea_, javax.swing.GroupLayout.DEFAULT_SIZE, 138, Short.MAX_VALUE)
