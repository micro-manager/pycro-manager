...
//      }
   ...
   private void initComponents() {
      ...
      currentGridCombo_.setModel(manager_.createGridComboBoxModel());
      ...
      currentSufaceCombo_.setModel(manager_.createSurfaceComboBoxModel());
   ...
   private void tabbedPane_StateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_tabbedPane_StateChanged
      if (tabbedPane_.getSelectedIndex() == 0) { //status
         ...
         if (manager_.getNumberOfGrids() == 0) {
            manager_.addNewGrid(createNewGrid());
   ...
   private void gridRowsSpinner_StateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_gridRowsSpinner_StateChanged
      ...
      if (index != -1 && updateGridParams_) {
         MultiPosGrid r = manager_.getGrid(index);
   ...
   private void currentGridCombo_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_currentGridCombo_ActionPerformed
      display_.setCurrentRegion(manager_.getGrid(currentGridCombo_.getSelectedIndex()));
      if (currentGridCombo_.getSelectedItem() != null) {
         ...
         gridRowsSpinner_.setValue(manager_.getGrid(currentGridCombo_.getSelectedIndex()).numRows());
         gridColsSpinner_.setValue(manager_.getGrid(currentGridCombo_.getSelectedIndex()).numCols());
